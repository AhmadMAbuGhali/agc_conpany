...
class SalespersonToAccountant extends StatelessWidget {
  @override
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ElevatedButton(onPressed: () => Get.to(()=>NavScreen()),
                        child: Text('تحويل الى المحاسب',style: getRegularStyle(color: ColorManager.white,fontSize: FontSize.s10.sp),)
