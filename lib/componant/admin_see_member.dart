                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ElevatedButton(onPressed: () => Get.to(()=>NavScreen()),
                        child: Text('تغيير كلمة المرور ',style: getRegularStyle(color: ColorManager.white,fontSize: FontSize.s10.sp),)
                    ...
                    , SizedBox(
                      ...
                      height: 20.h,
                      child: ElevatedButton(onPressed: () => Get.to(()=>NavScreen()),
                        child:Text('تعطيل الحساب ',style: getRegularStyle(color: ColorManager.reject,fontSize: FontSize.s14.sp),)
                        ,style: ElevatedButton.styleFrom(
