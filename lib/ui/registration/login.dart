      ...
      body: SafeArea(
        ...
        children: [
              ...
              child: Stack(
                ...
                children: [
                  ...
                  const Positioned(
                    ...
                    child: const Text('مرحباً ',style: TextStyle(
                        fontSize: 30,
                        color: Colors.white,
                        fontWeight: FontWeight.bold
                    ),),),
                  const Positioned(
                    ...
                    child: const Text('سجل الدخول للمتابعة ',style: TextStyle(
                        fontSize: 18,
                        color: Colors.white,
                        fontWeight: FontWeight.bold
                    ),),),
          ...
          Padding(
            ...
            child: TextButton(onPressed: (){}, child: const Text('هل نسيت كلمة المرور ؟',
          ...
          Padding(
            ...
            child: PrimaryButton(onTap: () {  }, label: 'تسجيل الدخول ',),
          ),
          SizedBox(height: 18.h,),
         Padding(
           ...
           child: Row(
             ...
             Text(' ليس لديك حساب؟  ',style: TextStyle(
               ...
               TextButton(onPressed: (){}, child: const Text('تسجيل',style: TextStyle(
                 fontWeight: FontWeight.bold,
                 color: Colors.black
               ),))
