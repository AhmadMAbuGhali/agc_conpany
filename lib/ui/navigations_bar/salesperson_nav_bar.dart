...
import '../company_member/salesperson/salesperson_home.dart';
import '../company_member/salesperson/salesperson_transfer_order.dart';
...
class _HomeScreenState extends State<SalespersonNavBar> {
  final pages = [
    ...
    SalespersonCustomerOrder(),

    SalespersonTransferOrder(),
